...
public class VectorJugable {
	...
	public static String infoVector(Vector<Jugable> vector){
		System.out.println("Tamañoo del vector: "+vector.size()+ " Capacidad del vector: "+vector.capacity());
		return ("Tamañoo del vector: "+vector.size()+ " Capacidad del vector: "+vector.capacity());
	}
